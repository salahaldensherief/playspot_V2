...
تفضل الملف النهائي المكتمل كلياً متضمناً القاعدة الجديدة، عشان ترفعه أو تحفظه دفعة واحدة:
...
## 2. GoRouter & Provider Scoping (CRITICAL)
...
## 3. UI Performance & Minimal Rebuilds
